// next move change to class that called data
...
List<List<dynamic>> userMessage = [
  ...
  [
    ...
    ["This is Person B's message", true],
    ["Another message from Person B", true],
    ["Yes, the weather is perfect!", false],
    ["I went hiking over the weekend.", true],
    ["That sounds adventurous! How was it?", false],
    ["It was breathtaking! The views were amazing.", true],
    ["I watched that movie too. I loved it!", false],
    ["That's awesome! Let's plan a movie night soon.", true],
    ["Sure, I can't wait!", false],
    ["The beach sounds relaxing. Enjoy your time there!", true],
    ["Thank you! I'll make sure to relax and have fun.", false],
    ["Looking forward to seeing your pictures!", false],
    ["Thanks! I'll share them with you.", true],
    ["You too! Have a wonderful day!", false],
    ["Thanks, take care!", true],
  ],
  ...
  [
    ...
    ["That's great! You've been doing amazing work lately.", false],
    ["Thank you so much! Your support means a lot to me.", true],
    ["You deserve it. Keep up the excellent work!", false],
    ...
    ["Sure, I'd love to try it. Let's plan it soon.", false],
  ...
  [
    ...
    ["That sounds like a lot of fun. Where did you go?", false],
    ["We explored the countryside and visited some scenic spots.", true],
    ["I wish I could have joined. The pictures looked amazing.", false],
    [
    ...
    ["I'll make sure to invite you. We always have a blast together.", false],
    [
